...
# under the License.
"""Metadata for downloadable chart-data export artifacts."""
...
class ChartDataExportArtifact(AuditMixinNullable, Model):
    """Opaque stored export bound to one private GTF task and datasource."""

    __tablename__ = "chart_data_export_artifacts"
